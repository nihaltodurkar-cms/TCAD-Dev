...
Full spec: pytcad/M31-CPP-ARCHITECTURE-PLAN.md. Progressive extraction (Architecture_Master_Plan.md section 37) -- NOT rewrite.
  ...
  P6  native QQuickVTKItem 3D viewport                SUPERSEDED
      (2026-09-25, user decision: replaced by the native Qt Widgets +
      VTK desktop app's P1 results viewer -- pytcad/NATIVE-DESKTOP-PLAN.md
      section 15; P0 of that plan landed the same day)
